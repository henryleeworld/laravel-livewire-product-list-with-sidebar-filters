<div class="mb-4 col-lg-3 space-y-2 divide-y divide-solid">
    <h1 class="mt-4 text-3xl">{{ __('Filters') }}</h1>
    ...
    <x-filter-group title="{{ __('Categories') }}" options="categories" selected="selected.categories" />

    <x-filter-group title="{{ __('Manufacturers') }}" options="manufacturers" selected="selected.manufacturers" />
</div>
